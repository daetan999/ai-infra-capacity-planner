...
DEMO_SCENARIOS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "description": (
            "Fictional regulated-enterprise RAG workload sizing retrieval and generation together."
        ),
        "workload_mode": "rag_inference",
        "inputs": {
            "model_family": "fictional private RAG generator",
            "model_parameters_billions": 70,
            "precision": "int8",
            ...
            "training_window_hours": 0,
            "storage_tb": 36,
            "storage_growth_pct": 35,
            "ingress_gbps": 4,
            "egress_gbps": 5,
            "region": "fictional-ap-regulated",
